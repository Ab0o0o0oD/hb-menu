                    ...
                    <div
                        ...
                        <div className='col-span-6'>
                            ...
                            <div className='md:flex align-middle justify-center lg:justify-end'>
                                <a href='#menu-section'
                                   className='flex border w-full md:w-auto mt-5 md:mt-0 border-primary justify-center rounded-full text-xl font-medium items-center py-5 px-10 text-black hover:text-white hover:bg-primary'>
                                    Explore our menu</a>
                            </div>
                        </div>
                    </div>
